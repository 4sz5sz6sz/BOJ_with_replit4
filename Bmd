...
입력
첫째 줄에는 경기에 참가한 선수의 수 
$N$이 주어진다.

둘째 줄에는 애리가 중계 방송을 켠 시점에서 각 선수의 등번호를 나타내는 
$N$개의 정수 
$A_1, \cdots, A_N$가 등수 순서대로 공백을 사이에 두고 주어진다.

셋째 줄에는 경기가 끝난 시점에서 각 선수의 등번호를 나타내는 
$N$개의 정수 
$B_1, \cdots, B_N$가 등수 순서대로 공백을 사이에 두고 주어진다.
...
예제 출력 1 
1023 1030
등 번호	처음 중계 방송을 켠 시점의 등수	경기가 끝난 시점의 등수	등수 변화
1023	3	1	+2
1030	4	2	+2
101	2	3	-1
411	1	4	-3
